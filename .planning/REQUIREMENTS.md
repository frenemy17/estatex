...
- [ ] **PROV-01**: Groq LLM integration reliably routes to active, supported models (`llama-3.3-70b-versatile`, `llama3-70b-8192`) with working credential validation.
- [ ] **PROV-02**: Cal.com integration verified live with valid API key and event type ID, rendering green status chip and functional booking.
- [ ] **PROV-03**: Resend email delivery verified with valid API key and working sender configuration.
- [ ] **PROV-04**: Twilio SMS verified with verified destination phone numbers and inbound `STOP` test.
- [ ] **PROV-05**: HubSpot CRM sync verified with valid access token, syncing contacts and associated deals.
...
|:---|:---|:---|
| PROV-01 | Phase 1: Real Provider Live Readiness | Pending |
| PROV-02 | Phase 1: Real Provider Live Readiness | Pending |
| PROV-03 | Phase 1: Real Provider Live Readiness | Pending |
| PROV-04 | Phase 1: Real Provider Live Readiness | Pending |
| PROV-05 | Phase 1: Real Provider Live Readiness | Pending |
